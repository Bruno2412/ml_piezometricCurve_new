...
@st.cache_data(ttl=1800, show_spinner="Lecture des chroniques...")
...
@st.cache_data(ttl=1800, show_spinner="Lecture du fichier Excel ...")
...
@st.cache_data(ttl=1800, show_spinner="Lecture de chroniques.txt (export ADES)...")
...
@st.cache_data(ttl=1800, show_spinner="Lecture du fichier descriptif...")
...
@st.cache_data(ttl=1800, show_spinner="Lecture de MassesEau.txt...")
